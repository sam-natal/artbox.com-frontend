    ...
    <!-- END Sidebar Scroll Container -->
         ...
         <!-- HEADER -->
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">All Polls</h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">All Polls</h3>
                            <a href="" class="btn  mb-2 text-white bg-gd-emerald" data-toggle="modal" data-target="#addPostModal">Add Polls</a>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell">Competitor</th>
                                        <th class="d-none d-sm-table-cell">polls</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600">
                                             <Span>Kelvin msindai</Span> <br>
                                            <Span>Cosmas Kidumule</Span>
                                        </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-info text-light bg-gd-emerald">
                        ...
                        <h3 class="block-title">Add Polls</h3>
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="register1-email">FullName:</label>
                            <div class="col-12">
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="register1-password">Position</label>
                            <div class="col-12">
