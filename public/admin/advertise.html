    ...
    <!-- END Sidebar Scroll Container -->
         ...
         <!-- HEADER -->
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Adverts</h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Advertise</h3>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600">Economic Depression</td>
                                        ...
                                        <td class="font-w600"><img style="width: 50px;" src="assets/img/photos/photo34.jpg" alt=""></td>
                                         ...
                                         <td class="d-none d-sm-table-cell"><a title="delete" href="""><img style="width: 16px;" src="assets/img/photos/delete.png" alt=""></a></td>
                                    </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-info text-light bg-gd-emerald">
                        ...
                        <h3 class="block-title">Add Advertise</h3>
