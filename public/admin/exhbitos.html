                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">All Exbitors</h3>
                            <a href="" class="btn  mb-2 text-white bg-gd-emerald" data-toggle="modal" data-target="#addPostModal">Add Exhibitors</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600">12:23</td>
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href=""><img style="width: 16px;" title="delete" src="assets/img/photos/delete.png" alt=""></a></td>
                                    </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-info text-light bg-gd-emerald">
                        ...
                        <h3 class="block-title">Add Exhibitor</h3>
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="register1-email">Exhibitor Name:</label>
                            <div class="col-12">
