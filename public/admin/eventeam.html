    ...
    <!-- END Sidebar Scroll Container -->
         ...
         <!-- HEADER -->
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Event Team</h2>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600">Chaiyoa Yateri</td>
                                        <td class="font-w600">Deevloper</td>
                                        <td class="font-w600">0764591224</td>
                                        <td class="font-w600">example@example.com</td>
                                        <td class="font-w600"><img style="width: 50px;" src="assets/img/avatars/avatar0.jpg" alt=""></td>
                    ...
                    <form action="" method="post">
                                ...
                                <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-alt-success" name="submit">
                                            <i class="fa fa-plus mr-5"></i> Add Team
                                        </button>
